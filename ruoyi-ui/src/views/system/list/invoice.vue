<template>
  <div class="invoice-body orange">
      ...
      <div class="invoice-body-up-left fl">
        <dl>
          <dt class="invoice-body-up-left-img">
            <img width="70" height="70" src="@/assets/images/1561108150.png" alt="二维码">
          </dt>
    ...
    <div class="invoice-table-footer ovh black">
      <div class="fl m-l14 w212"><span class="orange">收款人：</span>万一</div>
      <div class="fl m-l14 w160"><span class="orange">复核：</span>万一</div>
      <div class="fl m-l14 w150"><span class="orange">开票人：</span>万一</div>
...
import {getInfoById} from "@/api/system/booking";
